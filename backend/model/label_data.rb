...
class LabelData
  ...
  def agent_for_top_container(tc)
      ...
      agent_ref = tc['collection'][0]['_resolved']['linked_agents'].select{|a| a['role'] == 'creator'}.first
      agent_name = agent_ref.nil? ? '' : agent_ref['_resolved']['title']
